...
size_t TCPConnection::time_since_last_segment_received() const { return this->_sender.gettick() - this->_time_since_last_segment_received; }
...
bool TCPConnection::active() const { 
    ...
    {
        return !(this->_sender.is_sent_fin() && this->_sender.bytes_in_flight() == 0 && this->_receiver.unassembled_bytes() == 0);
    }
    else
    {
        if(this->_sender.is_sent_fin() && this->_sender.bytes_in_flight() == 0 && this->_is_recv_fin == true && this->_receiver.unassembled_bytes() == 0)
        {
