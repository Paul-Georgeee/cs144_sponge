...
class NetworkInterface {
  private:
    ...
    std::unordered_map<uint32_t, std::pair<std::queue<EthernetFrame>, uint64_t>> _wait_for_arp{};
  ...
  public:
    ...
    void send_arp_request(uint32_t dstip);

    void send_arp_reply(uint32_t dstip, EthernetAddress dstmac);
};
